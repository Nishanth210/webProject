    ...
    return (
        <>
            ...
            <div className="pl-5 py-2 mx-3 mt-3 bg-blue-300 rounded-lg pl-5 shadow-lg hover:shadow-2xl transition ease-in-out">
                <h1 className="mt-3 text-4xl">SCROLL DOWN TO VIEW LAB LIST</h1>
                ...
                <table className="bg-white border-collapse border border-slate-50 w-full max-w-6xl mx-auto text-center">
                    <thead>
                        <tr>
                            ...
                            <th className=" border-collapse border border-slate-300">Department</th>
                    ...
                    <tbody>
                        {departments.map((data, index) => (
                            <tr key={index}>
                                ...
                                <td className="bg-gray-100 border-collapse border border-slate-100">{data.department}</td>
